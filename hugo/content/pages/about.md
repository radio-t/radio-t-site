...
Обычно, через 2-6 часов после записи, появляется подкаст. Подписка на подкаст доступна [через наш прямой RSS](http://feeds.feedburner.com/Radio-t) а также [в Apple Podcasts](https://podcasts.apple.com/podcast/радио-т/id256504435).
...
Они, т.е. мы — это [Ksenks](https://twitter.com/ksenks), [Alek.sys](https://twitter.com/alek_sys), [Bobuk](https://twitter.com/bobuk) и [Umputun](http://umputun.com). Связаться с нами можно напрямую, написав либо в комментарии либо на [podcast@radio-t.com](mailto:podcast@radio-t.com).
